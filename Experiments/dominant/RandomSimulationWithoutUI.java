...
public class RandomSimulationWithoutUI {
    ...
    public static void main(String[] args)
    {
    	...
    	// HH 5.1.15 Additional Loop so that we can get 10 sets of 'background' failure data
    	//for (int m=4; m < 10; m++)
    	//{
    		...
    		for (int j = 1; j <= Constants.NO_RANDOM_RUNS; j++) {    	
    			...
    			for (int i=5; i < 21; i=i+5) // HH 8.1.15 - Start with 5% faults as already have a lot of data on 0% faults
    			{
    				//int i = 0;
